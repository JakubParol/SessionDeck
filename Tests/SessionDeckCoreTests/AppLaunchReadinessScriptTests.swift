...
func runAppScriptWaitsForMainWindowReadiness() throws {
    ...
    #expect(readinessScript.contains("detect_visible_main_window"))
    #expect(readinessScript.contains("CGWindowListCopyWindowInfo"))
    #expect(readinessScript.contains(".optionOnScreenOnly"))
    #expect(readinessScript.contains("kCGWindowOwnerName"))
    #expect(readinessScript.contains("kCGWindowLayer"))
